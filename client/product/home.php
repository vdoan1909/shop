                        ...
                        <div class="banner-inner">
                            <figure class="banner-thumb">
                                <img style="width: 500px; height: 400px;"
                                    src="https://amiri.com/cdn/shop/collections/Nav-Banner_PS24-Core-3.jpg?v=1701813116"
                ...
                <div class="col-md-12 col-lg-6">
                    <div class="akasha-banner style-01 right-top">
                        <div class="banner-inner">
                            <figure class="banner-thumb">
                                <img style="width: 500px; height: 400px;"
                                    src="https://lenshop.gr/images/products/original/saint-laurent-536-natalia-dyer.jpg"
                                    class="attachment-full size-full" alt="img">
                            </figure>
                            <div class="banner-info ">
                                <div class="banner-content">
                                    <div class="title-wrap">
                                        <h6 class="title">
                                            <a target="_self" href="#">Saint Laurent</a>
                                        </h6>
                                    </div>
                                    <div class="button-wrap">
                                    </div>
                    ...
                    <div class="akasha-banner style-01 left-bottom">
                        <div class="banner-inner">
                            <figure class="banner-thumb">
                                <img style="width: 500px; height: 400px;"
                                    src="https://colorising.com/wp-content/uploads/2018/03/louiebanner.jpg"
                                    class="attachment-full size-full" alt="img">
                            </figure>
                            <div class="banner-info ">
                                <div class="banner-content">
                                    <div class="title-wrap">
                                        <h6 class="title">
                                            <a target="_self" href="#">Louis Vuitton</a>
                                        </h6>
                                    </div>
                                    <div class="button-wrap">
                                    </div>
                        ...
                        <div class="product-inner tooltip-top">
                            <div class="product-thumb">
                                <a class="thumb-link" href="#" tabindex="0">
                                    <img class="img-responsive" src="assets/upload/<?= $sp_bc["anh"] ?>"
                                        alt="<?= $sp_bc["ten"] ?>" width="270" height="350">
                                </a>
                            </div>
                            <div class="product-info">
                                <h3 class="product-name product_title">
                                    <a href="index.php?url=ct_san_pham&id_sp_kc=<?= $sp_bc["id_sp_kc"] ?>&id_th=<?= $sp_bc["id_th"] ?>&id_tl=<?= $sp_bc["id_tl"] ?>&id_sp=<?= $sp_bc["id"] ?>"
                                        tabindex="0"><?= $sp_bc["ten"] ?></a>
                                </h3>
                                <span class="akasha-Price-currencySymbol"><?= $fm_gia ?> VND</span>
                            </div>
                            <div style="width: 50px; height: 50px;" class="group-button clearfix">
                ...
                <div class="response-product product-list-owl owl-slick equal-container better-height"
                    ...
                    <div
                        ...
                        <div class="product-inner tooltip-left">
                            <div class="product-thumb">
                                <a class="thumb-link" href="#" tabindex="0">
                                    <img class="img-responsive" src="assets/upload/<?= $sp_moi["anh"] ?>"
