            ...
            <div class="row">
                    ...
                    <div class="akasha-banner style-01 left-center">
                        <div class="banner-inner">
                            <figure class="banner-thumb">
                                <img style="width: 500px; height: 400px;" src="https://amiri.com/cdn/shop/collections/Nav-Banner_PS24-Core-3.jpg?v=1701813116" class="attachment-full size-full" alt="img">
                            </figure>
                ...
                <div class="col-md-12 col-lg-6">
                    <div class="akasha-banner style-01 right-top">
                        <div class="banner-inner">
                            <figure class="banner-thumb">
                                <img style="width: 500px; height: 400px;" src="https://lenshop.gr/images/products/original/saint-laurent-536-natalia-dyer.jpg" class="attachment-full size-full" alt="img">
                            </figure>
                            <div class="banner-info ">
                                <div class="banner-content">
                                    <div class="title-wrap">
                    ...
                    <div class="akasha-banner style-01 left-bottom">
                        <div class="banner-inner">
                            <figure class="banner-thumb">
                                <img style="width: 500px; height: 400px;" src="https://colorising.com/wp-content/uploads/2018/03/louiebanner.jpg" class="attachment-full size-full" alt="img">
                            </figure>
                            <div class="banner-info ">
                                <div class="banner-content">
                                    <div class="title-wrap">
