                                ...
                                <tbody id="order-cart">
                                    ...
                                    ?>
                                        <?php foreach ($ds_san_pham_gio_hang as $sp_gh) :
                                            ...
                                            $fm_tong_gia_gio_hang = number_format($tong_gia_gio_hang, 0, ',', '.');
                                        ?>
                                            <tr class="akasha-cart-form__cart-item cart_item">
                                                ...
                                                <td class="product-quantity" data-title="Quantity">
                                                    <input id="soluong_<?= $sp_gh["id"] ?>" type="number" min="1" max="<?= $sp_gh["sl_sp"] ?>" step="1" value="<?= $sp_gh["so_luong"] ?>" oninput="updateSoLuong(<?= $sp_gh['id'] ?>,<?= $sp_gh['sl_sp'] ?>)" />
                                                </td>
                            ...
                            <div class="cart_totals ">
                                ...
                                <table class="shop_table shop_table_responsive" cellspacing="0">
                                    <tr class="cart-subtotal">
                                        <th>Tổng phụ</th>
                                        <td data-title="Subtotal"><span class="akasha-Price-amount amount"><span class="akasha-Price-currencySymbol"><?= $fm_tong_gia_gio_hang ?></span>
                                                VND</span></td>
                                    </tr>
                                    <tbody>
                                        <tr class="order-total">
                                            <th>Tổng</th>
                                            <td data-title="Total"><strong><span class="akasha-Price-amount amount"><span class="akasha-Price-currencySymbol"><?= $fm_tong_gia_gio_hang ?></span>
                                                        VND</span></strong>
                                            </td>
                                        </tr>
                                    </tbody>
                                        ...
                                        <div class="product-inner tooltip-left">
                                            <div class="product-thumb">
                                                <a class="thumb-link" href="#" tabindex="0">
                                                    <img class="img-responsive" src="assets/upload/<?= $sp_bt["anh"] ?>" alt="Print In White" width="600" height="778">
                                                </a>
                                            ...
                                            <div class="product-info equal-elem">
                                                <h3 class="product-name product_title">
                                                    <a href="#" tabindex="0"><?= $sp_bt["ten"] ?></a>
                                                </h3>
                                                <span class="price">
                                                    <ins><span class="akasha-Price-amount amount"><span class="akasha-Price-currencySymbol"><?= $fm_gia_sp_bt ?></span>
                                                            VND</span></ins>
                                            </div>
                                        </div>
                                    </div>
